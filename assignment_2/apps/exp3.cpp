...
void sharpen_experiment(const std::string& image_path,std::optional<std::string> save_dir ) {
    ...
    imageproc::SharpenFilter sf(0.01, 5);
    ...
    if(save_dir.has_value()){
        ...
        imageproc::io::saveImage(s+"/exp_3_sharp_box_0.01.png" , sharp_img_box);
        imageproc::io::saveImage(s+"/exp_3_sharp_gaussian_0.01.png" , sharp_img_gaussian);
    }
